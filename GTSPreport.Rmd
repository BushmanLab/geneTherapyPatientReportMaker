...
detailedAbunds$maskedRefGeneName <- gsub('\\n', ' ', detailedAbunds$maskedRefGeneName)
detailedAbunds$maskedRefGeneName <- factor(detailedAbunds$maskedRefGeneName)
detailedAbunds$maskedRefGeneName <- relevel(detailedAbunds$maskedRefGeneName, 'LowAbund')
detailedAbunds$maskedRefGeneName <- factor(detailedAbunds$maskedRefGeneName, levels=rev(levels(detailedAbunds$maskedRefGeneName)))
...
# Remove position information
df$nearest_refSeq_gene <-   gsub('\\n.*', '', df$nearest_refSeq_gene)
